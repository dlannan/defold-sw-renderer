...
framebuffer_t *framebuffer_create(int width, int height) {
    ...
    framebuffer = new framebuffer_t();
    framebuffer->width = width;
    framebuffer->height = height;
    framebuffer->color_buffer = new unsigned char[color_buffer_size];
    framebuffer->depth_buffer = new float[depth_buffer_size];
...
void framebuffer_release(framebuffer_t *framebuffer) {
    delete framebuffer->color_buffer;
    delete framebuffer->depth_buffer;
    delete framebuffer;
}
